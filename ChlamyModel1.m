function [x,v,X]=ChlamyModel1(t,model)
...
% merge head and flagella positions
x=MergeVectorGrids(MergeVectorGrids(xh,xt),xc);
...
% merge head and flagella velocities
v=MergeVectorGrids(MergeVectorGrids(vh,vt),vc);
