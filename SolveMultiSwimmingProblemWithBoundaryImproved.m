function dz=SolveMultiSwimmingProblemWithBoundaryImproved(z,swimmer,boundary,t,epsilon,domain,rho,blockSize,varargin)
    ...
    %        rho     - 'near/far' threshold for improved NN implementation
    ...
    [AS,~]=AssembleStokesletMatrix2(x,X,epsilon,domain,rho,blockSize);
