function [hf,hq,f_hf,f_hq,h_hf,h_hq,f_min,q_min] = CalcDiscSpacingsChlamy(zz,tt,swimmer,boundary)
...
[xi,~,Xi]=ChlamyModel1_headonly(tt(1),swimmer.model);
xx0=ApplyRotationMatrix(B,xi); % x-x0
...
[xi,~,Xi]=ChlamyModel1_flagonly(tt(1),swimmer.model);
xx0=ApplyRotationMatrix(B,xi); % x-x0
