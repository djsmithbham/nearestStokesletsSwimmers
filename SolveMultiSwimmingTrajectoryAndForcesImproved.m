function [t,z]=SolveMultiSwimmingTrajectoryAndForcesImproved(x00,b10,b20,tRange,swimmer,boundary,epsilon,domain,rho,blockSize,varargin)
...
%   rho        'near/far' threshold length for improved NN code
...
[t,z]=ode45(@(t,z) SolveMultiSwimmingProblemWithBoundaryImproved(z,swimmer,boundary,t,epsilon,domain,rho,blockSize,varargin),tRange,z0);
